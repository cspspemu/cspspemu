...
namespace CSPspEmu.Core.Gpu.Impl.Opengl
{
	...
	{
		static readonly int[] StencilOperationTranslate =
		{
			GL.GL_KEEP,
			GL.GL_ZERO,
			GL.GL_REPLACE,
		...
		static readonly int[] StencilFunctionTranslate =
		{
			GL.GL_NEVER,
			GL.GL_ALWAYS,
			GL.GL_EQUAL,
		...
		static readonly int[] DepthFunctionTranslate =
		{
			GL.GL_NEVER,
			GL.GL_ALWAYS,
			GL.GL_EQUAL,
		...
		static readonly int[] BlendEquationTranslate =
		{
			GL.GL_FUNC_ADD,
			GL.GL_FUNC_SUBTRACT,
		...
		static readonly int[] BlendFuncSrcTranslate = 
		{
		...
		static readonly int[] BlendFuncDstTranslate =
		{
