...
//#endif
            {
                ...
                Crypto.AES_cbc_encrypt(&k1, inbuff + sizeof(AES128CMACHeader) + header->DataOffset,
                    outbuff + sizeof(AES128CMACHeader) + header->DataOffset, chk_size);
...
#else
                Crypto.AES_cbc_decrypt(aes_kirk1_ptr, inbuff, (byte*) &keys,
        ...
        public int kirk_decrypt_keys(byte* keys, byte* inbuff)
        {
            ...
            {
                Crypto.AES_cbc_decrypt(aes_kirk1_ptr, inbuff, (byte*) keys,
                    16 * 2); //decrypt AES & CMAC key to temp buffer
                return 0;
            }
        }
