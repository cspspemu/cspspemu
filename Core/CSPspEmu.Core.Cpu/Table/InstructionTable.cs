            ...
            get
            {
                if (_ALU == null)
                {
                    _ALU = new InstructionInfo[]
                    {
                        ...
                        ID(nameof(CpuEmitter.addiu), VM("001001:rs:rt:imm16"), "%t, %s, %i", ADDR_TYPE_NONE, 0),
            ...
            get
            {
                if (_SPECIAL == null)
                {
                    _SPECIAL = new InstructionInfo[]
                    {
                        ...
                        // Move (From/To) DR
                        ID("mfdr", VM("011100:00000:----------:00000:111101"), "%t, %r", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("mtdr", VM("011100:00100:----------:00000:111101"), "%t, %r", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                    };
                }
                return _SPECIAL;
        ...
        public static InstructionInfo[] COP0
        {
            get
            {
                if (_COP0 == null)
                {
                    ...
                    {
                        // C? (From/To) Cop0
                        ID("cfc0", VM("010000:00010:----------:00000:000000"), "%t, %p", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP), // CFC0(010000:00010:rt:c0cr:00000:000000)
                        ID("ctc0", VM("010000:00110:----------:00000:000000"), "%t, %p", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP), // CTC0(010000:00110:rt:c0cr:00000:000000)

                        // Move (From/To) Cop0
                        ID("mfc0", VM("010000:00000:----------:00000:000000"), "%t, %0", ADDR_TYPE_NONE,
                            0), // MFC0(010000:00000:rt:c0dr:00000:000000)
                        ID("mtc0", VM("010000:00100:----------:00000:000000"), "%t, %0", ADDR_TYPE_NONE,
            ...
            get
            {
                if (_VFPU == null)
                {
                    _VFPU = new InstructionInfo[]
                    {
                        ...
                        ID("vslt", VM("011011:111:vt:two:vs:one:vd"), "%zp, %yp, %xp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP), // FIXED 2013-07-14

                        // ROTate
                        ID("vrot", VM("111100:111:01:imm5:two:vs:one:vd"), "%zp, %ys, %vr", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        // Vfpu ZERO/ONE
                        ID("vzero", VM("110100:00:000:0:0110:two:0000000:one:vd"), "%zp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vone", VM("110100:00:000:0:0111:two:0000000:one:vd"), "%zp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        // Vfpu MOVe/SiGN/Reverse SQuare root/COSine/Arc SINe/LOG2
                        ID("vmov", VM("110100:00:000:0:0000:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vabs", VM("110100:00:000:0:0001:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vneg", VM("110100:00:000:0:0010:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vocp", VM("110100:00:010:0:0100:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vsgn", VM("110100:00:010:0:1010:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vrcp", VM("110100:00:000:1:0000:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vrsq", VM("110100:00:000:1:0001:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vsin", VM("110100:00:000:1:0010:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vcos", VM("110100:00:000:1:0011:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vexp2", VM("110100:00:000:1:0100:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vlog2", VM("110100:00:000:1:0101:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vsqrt", VM("110100:00:000:1:0110:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vasin", VM("110100:00:000:1:0111:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vnrcp", VM("110100:00:000:1:1000:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vnsin", VM("110100:00:000:1:1010:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vrexp2", VM("110100:00:000:1:1100:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        ID("vsat0", VM("110100:00:000:0:0100:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vsat1", VM("110100:00:000:0:0101:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        // Vfpu ConSTant
                        ID("vcst", VM("110100:00:011:imm5:two:0000000:one:vd"), "%zp, %vk", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        // Vfpu Matrix MULtiplication
                        ID("vmmul", VM("111100:000:vt:two:vs:one:vd"), "%zm, %tym, %xm", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ...
                        ID("vi2c", VM("110100:00:001:11:101:two:vs:one:vd"), "%zs, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vi2uc", VM("110100:00:001:11:100:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ...
                        ID(nameof(CpuEmitter.vhtfm2), VM("111100:001:vt:0:vs:0:vd"), "%zp, %ym, %xp", ADDR_TYPE_NONE, INSTR_TYPE_PSP),
                        ID(nameof(CpuEmitter.vhtfm3), VM("111100:010:vt:0:vs:1:vd"), "%zt, %yn, %xt", ADDR_TYPE_NONE, INSTR_TYPE_PSP),
                        ID(nameof(CpuEmitter.vhtfm4), VM("111100:011:vt:1:vs:0:vd"), "%zq, %yo, %xq", ADDR_TYPE_NONE, INSTR_TYPE_PSP),

                        ID(nameof(CpuEmitter.vsrt3), VM("110100:00:010:01000:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ...
                        ID("vidt", VM("110100:00:000:0:0011:two:0000000:one:vd"), "%zp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vmidt", VM("111100:111:00:00011:two:0000000:one:vd"), "%zm", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        ID("viim", VM("110111:11:0:vd:imm16"), "%xs, %vi", ADDR_TYPE_NONE, INSTR_TYPE_PSP),

                        ID("vmmov", VM("111100:111:00:00000:two:vs:one:vd"), "%zm, %ym", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vmzero", VM("111100:111:00:00110:two:0000000:one:vd"), "%zm", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vmone", VM("111100:111:00:00111:two:0000000:one:vd"), "%zp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ...
                        ID("vpfxd", VM("110111:10:------------:mskw:mskz:msky:mskx:satw:satz:saty:satx"),
                            "[%vp4, %vp5, %vp6, %vp7]", ADDR_TYPE_NONE, INSTR_TYPE_PSP),
                        ID("vpfxs",
                            VM(
                                "110111:00:----:negw:negz:negy:negx:cstw:cstz:csty:cstx:absw:absz:absy:absx:swzw:swzz:swzy:swzx"),
                            "[%vp0, %vp1, %vp2, %vp3]", ADDR_TYPE_NONE, INSTR_TYPE_PSP),
                        ID("vpfxt",
                            VM(
                        ...
                        ID("vrnds", VM("110100:00:001:00:000:two:vs:one:0000000"), "%ys", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vrndi", VM("110100:00:001:00:001:two:0000000:one:vd"), "%zp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vrndf1", VM("110100:00:001:00:010:two:0000000:one:vd"), "%zp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vrndf2", VM("110100:00:001:00:011:two:0000000:one:vd"), "%zp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        ID("vcmp", VM("011011:000:vt:two:vs:one:000:imm4"), "%Zn, %yp, %xp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        ID("vcmovf", VM("110100:10:101:01:imm3:two:vs:one:vd"), "%zp, %yp, %v3", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vcmovt", VM("110100:10:101:00:imm3:two:vs:one:vd"), "%zp, %yp, %v3", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        ID("vavg", VM("110100:00:010:00111:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE, INSTR_TYPE_PSP),
                        ID("vf2id", VM("110100:10:011:imm5:two:vs:one:vd"), "%zp, %yp, %v5", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vf2in", VM("110100:10:000:imm5:two:vs:one:vd"), "%zp, %yp, %v5", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vf2iu", VM("110100:10:010:imm5:two:vs:one:vd"), "%zp, %yp, %v5", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vf2iz", VM("110100:10:001:imm5:two:vs:one:vd"), "%zp, %yp, %v5", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vi2f", VM("110100:10:100:imm5:two:vs:one:vd"), "%zp, %yp, %v5", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ...
                        ID("vt4444.q", VM("110100:00:010:11001:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vt5551.q", VM("110100:00:010:11010:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vt5650.q", VM("110100:00:010:11011:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ...
                        ID("vbfy1", VM("110100:00:010:00010:two:vs:one:vd"), "%zp, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vbfy2", VM("110100:00:010:00011:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        ID("vf2h", VM("110100:00:001:10:010:two:vs:one:vd"), "%zs, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vh2f", VM("110100:00:001:10:011:two:vs:one:vd"), "%zq, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        ID("vi2s", VM("110100:00:001:11:111:two:vs:one:vd"), "%zs, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vi2us", VM("110100:00:001:11:110:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        ID("vlgb", VM("110100:00:001:10:111:two:vs:one:vd"), "%zs, %ys", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vqmul", VM("111100:101:vt:1:vs:1:vd"), "%zq, %yq, %xq", ADDR_TYPE_NONE, INSTR_TYPE_PSP),
                        ID("vs2i", VM("110100:00:001:11:011:two:vs:one:vd"), "%zq, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),

                        // Working on it.

                        //"110100:00:001:11:000:1000000010000001"
                        ID("vc2i", VM("110100:00:001:11:001:two:vs:one:vd"), "%zs, %ys, %xs", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vuc2i", VM("110100:00:001:11:000:two:vs:one:vd"), "%zq, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ...
                        ID("vsocp", VM("110100:00:010:00101:two:vs:one:vd"), "%zq, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vsrt1", VM("110100:00:010:00000:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vsrt2", VM("110100:00:010:00001:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vsrt4", VM("110100:00:010:01001:two:vs:one:vd"), "%zq, %yq", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
                        ID("vus2i", VM("110100:00:001:11010:two:vs:one:vd"), "%zq, %yp", ADDR_TYPE_NONE,
                            INSTR_TYPE_PSP),
        ...
        public static InstructionInfo[] VFPU_BRANCH
        {
            get
            {
                if (_VFPU_BRANCH == null)
                {
                    return new InstructionInfo[]
                    {
                        ID("bvf", VM("010010:01:000:imm3:00:imm16"), "%Zc, %O", ADDR_TYPE_16,
                            INSTR_TYPE_PSP | INSTR_TYPE_B),
                        ID("bvt", VM("010010:01:000:imm3:01:imm16"), "%Zc, %O", ADDR_TYPE_16,
                            INSTR_TYPE_PSP | INSTR_TYPE_B),
                        ID("bvfl", VM("010010:01:000:imm3:10:imm16"), "%Zc, %O", ADDR_TYPE_16,
                            INSTR_TYPE_PSP | INSTR_TYPE_B | INSTR_TYPE_LIKELY),
                        ID("bvtl", VM("010010:01:000:imm3:11:imm16"), "%Zc, %O", ADDR_TYPE_16,
                            INSTR_TYPE_PSP | INSTR_TYPE_B | INSTR_TYPE_LIKELY),
                    };
                }
                return _VFPU_BRANCH;
