...
namespace CSPspEmu.Core.Cpu
{
    public struct Instruction
    {
        ...
        {
            return (uint) (CurrentPC & ~0x0FFFFFFF) + (JUMP_Bits << 2);
        }
        ...
        public int RD
        {
            get { return (int) get(11 + 5 * 0, 5); }
            set { set(11 + 5 * 0, 5, (uint) value); }
        }

        public int RT
        {
            get { return (int) get(11 + 5 * 1, 5); }
            set { set(11 + 5 * 1, 5, (uint) value); }
        }

        public int RS
        {
            get { return (int) get(11 + 5 * 2, 5); }
        ...
        public int FD
        {
            get { return (int) get(6 + 5 * 0, 5); }
            set { set(6 + 5 * 0, 5, (uint) value); }
        }

        public int FS
        {
            get { return (int) get(6 + 5 * 1, 5); }
            set { set(6 + 5 * 1, 5, (uint) value); }
        }

        public int FT
        {
            get { return (int) get(6 + 5 * 2, 5); }
        ...
        public int IMM
        {
            get { return (int) (short) (ushort) get(0, 16); }
        ...
        public uint HIGH16
        {
            get { return get(16, 16); }
            set { set(16, 16, (uint) value); }
        }
        ...
        public uint SIZE_I
        {
            get { return MSB - LSB + 1; }
            set { MSB = LSB + value - 1; }
        }

        public uint LSB
        {
            get { return get(6 + 5 * 0, 5); }
            set { set(6 + 5 * 0, 5, value); }
        }

        public uint MSB
        {
            get { return get(6 + 5 * 1, 5); }
        ...
        public uint VT5_2
        {
            get { return VT5 | (VT2 << 5); }
        }

        public float IMM_HF
        {
            get { return HalfFloat.ToFloat(IMM); }
        }
