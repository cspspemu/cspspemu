...
namespace CSPspEmu.Core.Cpu.Emitter
{
    public sealed partial class CpuEmitter
    {
        ...
        public AstNodeStm vcmovf()
        {
            return _vcmovtf(false);
        }

        public AstNodeStm vcmovt()
        {
            return _vcmovtf(true);
        }
        ...
        public AstNodeStm bvf()
        {
            return _bvtf(false);
        }

        public AstNodeStm bvfl()
        {
            return bvf();
        }

        public AstNodeStm bvt()
        {
            return _bvtf(true);
        }

        public AstNodeStm bvtl()
        {
            return bvt();
        }
    }
