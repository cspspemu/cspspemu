...
namespace CSPspEmu.Core.Cpu.Emitter
{
    unsafe public sealed partial class CpuEmitter
    {
        ...
        {
            return VEC_VD.SetVector(Index => VEC_VS[Index] * CEL_VT.Get(), PC);
        }
        ...
        // vzero: Vector ZERO
        // vone : Vector ONE
        public AstNodeStm vzero()
        {
            return VEC_VD.SetVector((Index) => 0f, PC);
        }

        public AstNodeStm vone()
        {
            return VEC_VD.SetVector((Index) => 1f, PC);
        }
        ...
        {
            return VEC_VD.SetVector((Index) => ast.CallStatic((Func<float, float>) MathFloat.Abs, VEC_VS[Index]), PC);
        }

        public AstNodeStm vneg()
        {
            return VEC_VD.SetVector((Index) => -VEC_VS[Index], PC);
        }

        public AstNodeStm vocp()
        {
            return VEC_VD.SetVector((Index) => 1f - VEC_VS[Index], PC);
        }

        public AstNodeStm vsgn()
        {
            return VEC_VD.SetVector((Index) => ast.CallStatic((Func<float, float>) MathFloat.Sign, VEC_VS[Index]), PC);
        }

        public AstNodeStm vrcp()
        {
            return VEC_VD.SetVector((Index) => 1f / VEC_VS[Index], PC);
        }
        ...
        // vcst: Vfpu ConSTant
        public AstNodeStm vsqrt()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.Sqrt);
        }

        public AstNodeStm vrsq()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.RSqrt);
        }

        public AstNodeStm vsin()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.SinV1);
        }

        public AstNodeStm vcos()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.CosV1);
        }

        public AstNodeStm vexp2()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.Exp2);
        }

        public AstNodeStm vlog2()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.Log2);
        }

        public AstNodeStm vasin()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.AsinV1);
        }

        public AstNodeStm vnrcp()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.NRcp);
        }

        public AstNodeStm vnsin()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.NSinV1);
        }

        public AstNodeStm vrexp2()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.RExp2);
        }

        public AstNodeStm vsat0()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.Vsat0);
        }

        public AstNodeStm vsat1()
        {
            return _vfpu_call_ff((Func<float, float>) MathFloat.Vsat1);
        }
        ...
        public AstNodeStm vadd()
        {
            return VEC_VD.SetVector(Index => VEC_VS[Index] + VEC_VT[Index], PC);
        }

        public AstNodeStm vsub()
        {
            return VEC_VD.SetVector(Index => VEC_VS[Index] - VEC_VT[Index], PC);
        }

        public AstNodeStm vdiv()
        {
            return VEC_VD.SetVector(Index => VEC_VS[Index] / VEC_VT[Index], PC);
        }

        public AstNodeStm vmul()
        {
            return VEC_VD.SetVector(Index => VEC_VS[Index] * VEC_VT[Index], PC);
        }
        ...
        {
            return CEL_VT_NoPrefix.Set((float) Instruction.IMM, PC);
        }
        ...
        public AstNodeStm mfvme()
        {
            return ast.NotImplemented("mfvme");
        }

        public AstNodeStm mtvme()
        {
            return ast.NotImplemented("mtvme");
        }

        public AstNodeStm vfim()
        {
            return CEL_VT_NoPrefix.Set((float) Instruction.IMM_HF, PC);
        }


        public AstNodeStm vlgb()
        {
            return ast.NotImplemented("vlgb");
        }

        public AstNodeStm vsbn()
        {
            return ast.NotImplemented("vsbn");
        }

        public AstNodeStm vsbz()
        {
            return ast.NotImplemented("vsbz");
        }
        ...
        public AstNodeStm vus2i()
        {
            return ast.NotImplemented("vus2i");
        }
        ...
        {
            return CEL_VD.Set(_Aggregate(0f, (Value, Index) => Value + VEC_VS[Index]), PC);
        }

        public AstNodeStm vavg()
        {
            return CEL_VD.Set(_Aggregate(0f, (Value, Index) => Value + VEC_VS[Index]) / (float) ONE_TWO, PC);
        }
        ...
        {
            return _vpfx_dst(PrefixDestination, CpuEmitterUtils._vpfxd_impl);
        }

        public AstNodeStm vpfxs()
        {
            return _vpfx_dst(PrefixSource, CpuEmitterUtils._vpfxs_impl);
        }

        public AstNodeStm vpfxt()
        {
            return _vpfx_dst(PrefixTarget, CpuEmitterUtils._vpfxt_impl);
        }
        ...
        {
            return ast.Statement(ast.CallStatic((Action<CpuThreadState, int>) CpuEmitterUtils._vrnds,
                ast.CpuThreadState));
        }

        public AstNodeStm vrndi()
        {
            return VEC_VD_i.SetVector(
                Index => ast.CallStatic((Func<CpuThreadState, int>) CpuEmitterUtils._vrndi, ast.CpuThreadState), PC);
        }

        public AstNodeStm vrndf1()
        {
            return VEC_VD.SetVector(
                Index => ast.CallStatic((Func<CpuThreadState, float>) CpuEmitterUtils._vrndf1, ast.CpuThreadState), PC);
        }

        public AstNodeStm vrndf2()
        {
            return VEC_VD.SetVector(
                Index => ast.CallStatic((Func<CpuThreadState, float>) CpuEmitterUtils._vrndf2, ast.CpuThreadState), PC);
        }
        ...
        {
            return MAT_VD.SetMatrix((Column, Row) => (Column == Row) ? 1f : 0f, PC);
        }

        public AstNodeStm vmzero()
        {
            return MAT_VD.SetMatrix((Column, Row) => 0f, PC);
        }

        public AstNodeStm vmone()
        {
            return MAT_VD.SetMatrix((Column, Row) => 1f, PC);
        }

        public AstNodeStm vmscl()
        {
            return MAT_VD.SetMatrix((Column, Row) => MAT_VS[Column, Row] * CEL_VT.Get(), PC);
        }
        ...
        {
            return MAT_VD.SetMatrix((Column, Row) => MAT_VS[Column, Row], PC);
        }

        public AstNodeStm vuc2i()
        {
            return VEC_VD_u.SetVector(
                Index => ast.Binary((ast.Binary(CEL_VS_u.Get(), ">>", (Index * 8)) & 0xFF) * 0x01010101, ">>", 1), PC);
        }

        public AstNodeStm vc2i()
        {
            return VEC_VD_u.SetVector(Index => ast.Binary(CEL_VS_u.Get(), "<<", ((3 - Index) * 8)) & 0xFF000000, PC);
        }

        // Vfpu Integer to(2) Color?
        public AstNodeStm vi2c()
        {
            var VEC_VS = VEC(VS, VType.VUInt, 4);
            return CEL_VD_u.Set(
                ast.CallStatic((Func<uint, uint, uint, uint, uint>) CpuEmitterUtils._vi2c_impl, VEC_VS[0], VEC_VS[1],
                    VEC_VS[2], VEC_VS[3]), PC);
        }

        public AstNodeStm vi2uc()
        {
            var VEC_VS = VEC(VS, VType.VInt, 4);
            return CEL_VD_u.Set(
                ast.CallStatic((Func<int, int, int, int, uint>) CpuEmitterUtils._vi2uc_impl, VEC_VS[0], VEC_VS[1],
                    VEC_VS[2], VEC_VS[3]), PC);
        }
        ...
        {
            return _vf2i_dnu(MathFloat.Floor);
        }

        public AstNodeStm vf2in()
        {
            return _vf2i_dnu(MathFloat.Round);
        }

        public AstNodeStm vf2iu()
        {
            return _vf2i_dnu(MathFloat.Ceil);
        }
        ...
        public AstNodeStm vmfvc()
        {
            return ast.NotImplemented("vmfvc");
        }

        public AstNodeStm vmtvc()
        {
            return ast.NotImplemented("vmtvc");
        }

        public AstNodeStm mtv()
        {
            return CEL_VD.Set(ast.GPR_f(RT), PC);
        }
        ...
        {
            return ast.AssignGPR_F(RT, CEL_VD.Get());
        }
        ...
        private delegate void _lvl_svl_q_Delegate(CpuThreadState CpuThreadState, bool Save, float* r0, float* r1,
        ...
        {
            return _lv_sv_l_r_q(left: true, save: false);
        }

        public AstNodeStm svl_q()
        {
            return _lv_sv_l_r_q(left: true, save: true);
        }

        public AstNodeStm lvr_q()
        {
            return _lv_sv_l_r_q(left: false, save: false);
        }

        public AstNodeStm svr_q()
        {
            return _lv_sv_l_r_q(left: false, save: true);
        }

        public AstNodeStm lv_s()
        {
            return _Cell(VT5_2).Set(ast.MemoryGetValue<float>(Memory, Address_RS_IMM14()), PC);
        }

        public AstNodeStm sv_s()
        {
            return ast.MemorySetValue<float>(Memory, Address_RS_IMM14(), _Cell(VT5_2).Get());
        }
    }
}