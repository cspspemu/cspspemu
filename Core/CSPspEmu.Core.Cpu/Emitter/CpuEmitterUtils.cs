...
namespace CSPspEmu.Core.Cpu.Emitter
{
    public unsafe class CpuEmitterUtils
    {
        ...
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
        [TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries")]
        public unsafe static int _max_impl(int Left, int Right)
        {
        ...
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
        [TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries")]
        public unsafe static int _min_impl(int Left, int Right)
        {
            return (Left < Right) ? Left : Right;
        }
        ...
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
        [TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries")]
        public static void _comp_impl(CpuThreadState CpuThreadState, float s, float t, bool fc_unordererd,
            bool fc_equal, bool fc_less, bool fc_inv_qnan)
        {
