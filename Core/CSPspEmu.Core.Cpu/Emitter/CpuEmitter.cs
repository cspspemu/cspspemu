...
namespace CSPspEmu.Core.Cpu.Emitter
{
    public unsafe sealed partial class CpuEmitter
    {
        ...
        private int ONE_TWO
        {
            get { return Instruction.ONE_TWO; }
        }

        private int RT
        {
            get { return Instruction.RT; }
        }

        private int RD
        {
            get { return Instruction.RD; }
        }

        private int RS
        {
            get { return Instruction.RS; }
        }

        private int IMM
        {
            get { return Instruction.IMM; }
        }

        private uint IMMU
        {
            get { return Instruction.IMMU; }
        }

        private int FT
        {
            get { return Instruction.FT; }
        }

        private int FD
        {
            get { return Instruction.FD; }
        }

        private int FS
        {
            get { return Instruction.FS; }
        }

        private AstNodeExpr IMM_s()
        {
            return ast.Immediate(IMM);
        }

        private AstNodeExpr IMM_u()
        {
            return ast.Immediate((uint) (ushort) IMM);
        }

        private AstNodeExpr IMM_uex()
        {
            return ast.Immediate((uint) IMM);
        }
