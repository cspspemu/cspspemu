...
namespace CSPspEmu.Core.Cpu.Emitter
{
	public sealed partial class CpuEmitter
	{
		...
		{
			return ast.NotImplemented("_vcmp_end");
		...
		{
			return ast.NotImplemented("vcmp");
		...
		{
			return ast.NotImplemented("_vsltge");
		...
		{
			return ast.NotImplemented("vscmp");
			//var VectorSize = Instruction.ONE_TWO;
			//
			//VectorOperationSaveVd(VectorSize, (Index) =>
			//{
		...
		*/
		...
		{
			return ast.NotImplemented("_vcmovtf"); ;
