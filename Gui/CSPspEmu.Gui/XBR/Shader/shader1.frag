...
void main(void)
{
	...
	vec4 A = vec4(texture2D(OGL2Texture, v_texcoords.xy -dx -dy).xyz, 0.0);
	vec4 B = vec4(texture2D(OGL2Texture, v_texcoords.xy -dy).xyz, 0.0);
	vec4 C = vec4(texture2D(OGL2Texture, v_texcoords.xy +dx -dy).xyz, 0.0);
	vec4 D = vec4(texture2D(OGL2Texture, v_texcoords.xy -dx ).xyz, 0.0);
	vec4 E = vec4(texture2D(OGL2Texture, v_texcoords.xy ).xyz, 0.0);
	vec4 F = vec4(texture2D(OGL2Texture, v_texcoords.xy +dx ).xyz, 0.0);
	vec4 G = vec4(texture2D(OGL2Texture, v_texcoords.xy -dx +dy).xyz, 0.0);
	vec4 H = vec4(texture2D(OGL2Texture, v_texcoords.xy +dy).xyz, 0.0);
	vec4 I = vec4(texture2D(OGL2Texture, v_texcoords.xy +dx +dy).xyz, 0.0);

	vec4 A1 = vec4(texture2D(OGL2Texture, v_texcoords.xy -dx -2.0*dy).xyz, 0.0);
	vec4 C1 = vec4(texture2D(OGL2Texture, v_texcoords.xy +dx -2.0*dy).xyz, 0.0);
	vec4 A0 = vec4(texture2D(OGL2Texture, v_texcoords.xy -2.0*dx -dy).xyz, 0.0);
	vec4 G0 = vec4(texture2D(OGL2Texture, v_texcoords.xy -2.0*dx +dy).xyz, 0.0);
	vec4 C4 = vec4(texture2D(OGL2Texture, v_texcoords.xy +2.0*dx -dy).xyz, 0.0);
	vec4 I4 = vec4(texture2D(OGL2Texture, v_texcoords.xy +2.0*dx +dy).xyz, 0.0);
	vec4 G5 = vec4(texture2D(OGL2Texture, v_texcoords.xy -dx +2.0*dy).xyz, 0.0);
	vec4 I5 = vec4(texture2D(OGL2Texture, v_texcoords.xy +dx +2.0*dy).xyz, 0.0);
	vec4 B1 = vec4(texture2D(OGL2Texture, v_texcoords.xy -2.0*dy).xyz, 0.0);
	vec4 D0 = vec4(texture2D(OGL2Texture, v_texcoords.xy -2.0*dx ).xyz, 0.0);
	vec4 H5 = vec4(texture2D(OGL2Texture, v_texcoords.xy +2.0*dy).xyz, 0.0);
	vec4 F4 = vec4(texture2D(OGL2Texture, v_texcoords.xy +2.0*dx ).xyz, 0.0);
