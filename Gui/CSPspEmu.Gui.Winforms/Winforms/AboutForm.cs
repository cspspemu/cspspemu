...
namespace CSPspEmu.Gui.Winforms
{
	public partial class AboutForm : Form
	{
		...
		{
			new Library() { Name = "MaiAT3PlusDecoder", Author = "ryuukazenomai", Url = "http://sourceforge.net/projects/maiat3plusdec/" },
			new Library() { Name = "HQ2X", Author = "Ivan Neeson", Url = "https://code.google.com/p/hq2x-csharp/" },
			new Library() { Name = "xBR", Author = "Hyllian/Hawkynt", Url = "http://board.byuu.org/viewtopic.php?f=10&t=2248" },
