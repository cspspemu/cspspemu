        ...
        public virtual bool CellEditEnterChangesRows
        {
            ...
            set
            {
                ...
                if (cellEditEnterChangesRows)
                {
                    ...
                    this.CellEditKeyEngine.SetKeyBehaviour(Keys.Enter | Keys.Shift,
                        CellEditCharacterBehaviour.ChangeRowUp, CellEditAtEdgeBehaviour.ChangeColumn);
                }
                else
                {
...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        [Category("ObjectListView"),
         Description(
             "The background color of selected rows when the control is owner drawn and doesn't have the focus"),
         DefaultValue(typeof(Color), "")]
        ...
        [Category("ObjectListView"),
         Description(
             "The foreground color of selected rows when the control is owner drawn and doesn't have the focus"),
         DefaultValue(typeof(Color), "")]
        ...
        public virtual void BuildGroups()
        {
            this.BuildGroups(this.LastSortColumn,
                this.LastSortOrder == SortOrder.None ? SortOrder.Ascending : this.LastSortOrder);
        }
...
#pragma warning restore 168
            ...
            OLVColumn column, SortOrder order, OLVColumn secondaryColumn, SortOrder secondaryOrder)
        {
            ...
            string titleSingularFormat = this.ShowItemCountOnGroups
        ...
        protected OlvListViewHitTestInfo LowLevelHitTest(int x, int y)
        {
            ...
            OLVListSubItem subItem = (this.View == View.Details && hitItem != null)
            ...
            OlvListViewHitTestInfo olvListViewHitTest =
                new OlvListViewHitTestInfo(hitItem, subItem, lParam.flags, group);
        ...
        protected virtual void CalculateOwnerDrawnHitTest(OlvListViewHitTestInfo hti, int x, int y)
        {
            ...
            IRenderer renderer = this.View == View.Details
                ? (hti.Column.Renderer ?? this.DefaultRenderer)
                : this.ItemRenderer;
...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        protected virtual bool HandleBeginScroll(ref Message m)
        {
            ...
            NativeMethods.NMLVSCROLL nmlvscroll =
                (NativeMethods.NMLVSCROLL) m.GetLParam(typeof(NativeMethods.NMLVSCROLL));
            if (nmlvscroll.dx != 0)
            {
        ...
        protected virtual void HandleColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            if (this.LastSortColumn != null && e.Column == this.LastSortColumn.Index)
                this.LastSortOrder = (this.LastSortOrder == SortOrder.Descending
                    ? SortOrder.Ascending
            ...
            switch (nmcustomdraw.nmcd.dwDrawStage)
            {
                ...
                case CDDS_SUBITEMPREPAINT:
                    ...
                    using (Graphics g = Graphics.FromHdc(nmcustomdraw.nmcd.hdc))
                    {
                        ...
                        DrawListViewSubItemEventArgs args = new DrawListViewSubItemEventArgs(g, r, item,
                            item.SubItems[0], rowIndex, 0,
        ...
        protected virtual bool HandleFindItem(ref Message m)
        {
            ...
            NativeMethods.LVFINDINFO findInfo =
                (NativeMethods.LVFINDINFO) m.GetLParam(typeof(NativeMethods.LVFINDINFO));
        ...
        protected virtual bool HandleGroupInfo(ref Message m)
        {
            ...
            foreach (OLVGroup group in this.OLVGroups)
            {
                ...
                {
                    GroupStateChangedEventArgs args = new GroupStateChangedEventArgs(group,
                        (GroupState) nmlvgroup.uOldState, (GroupState) nmlvgroup.uNewState);
                ...
                case HDN_TRACKW:
                    if (nmheader.iItem >= 0 && nmheader.iItem < this.Columns.Count)
                    {
                        NativeMethods.HDITEM hditem =
                            (NativeMethods.HDITEM) Marshal.PtrToStructure(nmheader.pHDITEM,
                                typeof(NativeMethods.HDITEM));
                        OLVColumn column = this.GetColumn(nmheader.iItem);
        ...
        public virtual ToolStripDropDown MakeColumnCommandMenu(ToolStripDropDown strip, int columnIndex)
        {
            ...
            else
            {
                ...
                {
                    strip.Items.Add(label, null,
                        (EventHandler) delegate(object sender, EventArgs args) { this.Unsort(); });
                }
            }
        ...
        {
            if (this.UpdateSpaceFillingColumnsWhenDraggingColumnDivider &&
                !this.GetColumn(e.ColumnIndex).FillsFreeSpace)
            {
        ...
        private void RunWhenIdle(EventHandler eventHandler)
        {
            ...
            {
                SynchronizationContext.Current.Post(delegate(object x) { Application.RaiseIdle(EventArgs.Empty); },
                    null);
            }
        }
        ...
        public virtual void ToggleSubItemCheckBox(object rowObject, OLVColumn column)
        {
            ...
            SubItemCheckingEventArgs args = new SubItemCheckingEventArgs(column, this.ModelToItem(rowObject),
                column.Index, currentState, newState);
        ...
        protected virtual void ShowSortIndicator(OLVColumn columnToSort, SortOrder sortOrder)
        {
            ...
            if (!NativeMethods.HasBuiltinSortIndicators())
            {
                ...
                imageIndex = this.SmallImageList.Images.IndexOfKey(sortOrder == SortOrder.Ascending
        ...
        protected virtual void MakeSortIndicatorImages()
        {
            ...
            if (il.Images.IndexOfKey(SORT_INDICATOR_UP_KEY) == -1)
            {
                ...
                il.Images.Add(SORT_INDICATOR_UP_KEY,
                    this.MakeTriangleBitmap(il.ImageSize, new Point[] {pt1, pt2, pt3}));
            }
            ...
            if (il.Images.IndexOfKey(SORT_INDICATOR_DOWN_KEY) == -1)
            {
                ...
                Point pt3 = new Point(midX + deltaX, midY - deltaY);
                il.Images.Add(SORT_INDICATOR_DOWN_KEY,
                    this.MakeTriangleBitmap(il.ImageSize, new Point[] {pt1, pt2, pt3}));
            }
...
#pragma warning restore 168
        ...
        public virtual void FinishCellEdit(bool expectingCellEdit)
        {
            ...
            if (!this.cellEditEventArgs.Cancel)
            {
                this.cellEditEventArgs.Column.PutValue(this.cellEditEventArgs.RowObject,
                    this.cellEditEventArgs.NewValue);
        ...
        /// <param name="olvi"></param>
        protected virtual void UpdateHotRow(int rowIndex, int columnIndex, HitTestLocation hitLocation,
            OLVListItem olvi)
        {
