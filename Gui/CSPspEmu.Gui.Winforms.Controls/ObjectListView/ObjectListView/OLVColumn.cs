...
namespace BrightIdeasSoftware
{
    ...
    public partial class OLVColumn : ColumnHeader
    {
            ...
            get
            {
                ...
                if (this.ListView != null)
                {
                    cachedGroupWithItemCountSingularFormat =
                        ((ObjectListView) this.ListView).GroupWithItemCountSingularFormatOrDefault;
        ...
        /// </summary>
        [Browsable(false)]
        public bool HasFilterIndicator => this.UseFiltering && this.ValuesChosenForFiltering != null &&
                                          this.ValuesChosenForFiltering.Count > 0;
        ...
        {
            get => headerTextAlign.HasValue ? headerTextAlign.Value : this.TextAlign;
            ...
            string[] tasks)
        {
            ...
            // Install a delegate that returns the index of the description to be shown
            this.GroupKeyGetter = delegate(object row) { return valuesArray.IndexOf(this.GetValue(row)); };
