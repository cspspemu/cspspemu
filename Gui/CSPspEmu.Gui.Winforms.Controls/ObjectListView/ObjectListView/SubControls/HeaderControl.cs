    ...
    public class HeaderControl : NativeWindow
    {
        ...
        protected virtual void CreateToolTip()
        {
            ...
            this.ToolTip.Showing +=
                new EventHandler<ToolTipShowingEventArgs>(this.ListView.HeaderToolTipShowingCallback);
        }
        ...
        internal virtual bool HandleHeaderCustomDraw(ref Message m)
        {
            ...
            NativeMethods.NMCUSTOMDRAW nmcustomdraw =
                (NativeMethods.NMCUSTOMDRAW) m.GetLParam(typeof(NativeMethods.NMCUSTOMDRAW));
        ...
        protected bool HandleLayout(ref Message m)
        {
            ...
            NativeMethods.RECT rect =
                (NativeMethods.RECT) Marshal.PtrToStructure(hdlayout.prc, typeof(NativeMethods.RECT));
            NativeMethods.WINDOWPOS wpos =
        ...
        protected void CustomDrawHeaderCell(Graphics g, int columnIndex, int itemState)
        {
            ...
            HeaderStateStyle stateStyle =
                this.CalculateStyle(column, columnIndex == this.ColumnIndexUnderCursor, isPressed);
