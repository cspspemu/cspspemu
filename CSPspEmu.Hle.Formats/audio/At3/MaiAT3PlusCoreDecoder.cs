...
{
	public class MaiAT3PlusCoreDecoderChnACCData_Entry
	{
		public int num_acc;
	...
	public class MaiAT3PlusCoreDecoderChnACCData
	{
	...
	unsafe public class MaiAT3PlusCoreDecoderChnACCTableTable
	{
	...
	public class MaiAT3PlusCoreDecoderChnACCTable
	{
	...
	unsafe public class MaiAT3PlusCoreDecoderChnInfo
	{
		public int chn_flag;
	...
	public class MaiAT3PlusCoreDecoderChnACCTableData
	{
		public int unk0;
		public int unk1;
		public int unk2;
	...
	public class MaiAT3PlusCoreDecoderChnACCTableInner
	{
		public int unk0;
		public int unk1;
		public int unk2;
	...
	public class MaiAT3PlusCoreDecoderPackTable0
	{
	...
	public class MaiAT3PlusCoreDecoderJointChnInfo
	{
	...
	public partial class MaiAT3PlusCoreDecoder
	{
		...
		int decodeBandNum(MaiBitReader mbr0, MaiAT3PlusCoreDecoderChnInfo[] chn_infos)
		{
			...
			chn_infos[0].joint_chn_info.num_band_declared =
				(uint)MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_band_num_table0[chn_infos[0].joint_chn_info.num_band_splited_declared] + 1;
		...
		int decodeTable0(MaiBitReader mbr0, MaiAT3PlusCoreDecoderChnInfo[] chn_infos, uint chns)
		{
			...
			chn_infos[0].joint_chn_info.num_band_used =
				(uint)MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_band_num_table0[chn_infos[0].joint_chn_info.num_band_splited_used] + 1;
		...
		int decodeTable3(MaiBitReader mbr0, MaiAT3PlusCoreDecoderChnInfo[] chn_infos, uint chns)
		{
			...
			for (uint a0 = 0; a0 < chns; a0++)
			{
				...
				for (uint a1 = 0; a1 < chn_infos[0].joint_chn_info.num_band_splited_used; a1++)
				{
					if (chn_infos[a0].table0[a1] == 0)
					{
						for (uint a2 = 0; a2 < MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_bind_table1[a1]; a2++) chn_infos[a0].table3[MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_bind_table0[a1] + a2] = 0;
					}
					else
					{
						uint atmp0 = 0;

						if (0 == chn_infos[a0].joint_chn_info.var90) atmp0 = MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_bind_table2[(chn_infos[a0].var1034 * 7 + chn_infos[a0].table0[a1]) * 4 + chn_infos[a0].table2[a1]]; //tmp4 5 6
						else atmp0 = chn_infos[a0].table2[a1];

						MaiAT3PlusCoreDecoderSearchTableDes huff_table_now = MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_huff_table3[(chn_infos[a0].var1034 * 8 + atmp0) * 7 + chn_infos[a0].table0[a1]]; //tmp5 6

						MAPCDSF_decodeTable3Sub0(mbr0, chn_infos[a0].table3.GetPointer((int)MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_bind_table0[a1]), MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_bind_table1[a1], huff_table_now);
					}
				}

				if (chn_infos[0].joint_chn_info.num_band_splited_used > 2)
				{
					for (uint a1 = 0; a1 < (uint)(MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_band_num_table1[MaiAT3PlusCoreDecoder_StaticData.MAPCDSD_band_num_table0[chn_infos[0].joint_chn_info.num_band_splited_used] + 1] + 1); a1++)
					{
