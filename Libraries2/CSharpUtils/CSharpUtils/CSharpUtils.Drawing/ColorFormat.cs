namespace CSharpUtils
{
	public struct ColorFormat
	{
		public struct Component
		{
			public int Offset;
			public int Size;
			public uint Mask { get { return (uint)((1 << Size) - 1); } }
		...
		*/
		...
		public int[] Offsets {
			get
			{
				return new[] { Red.Offset, Green.Offset, Blue.Offset, Alpha.Offset };
			}
			set
			{
				Red.Offset = value[0];
		...
		public int[] Sizes
		{
			get
			{
				return new[] { Red.Size, Green.Size, Blue.Size, Alpha.Size };
			}
			set
			{
				Red.Size = value[0];
