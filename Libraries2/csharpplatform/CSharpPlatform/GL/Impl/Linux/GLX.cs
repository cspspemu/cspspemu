...
namespace CSharpPlatform.GL.Impl.Linux
{
	...
	unsafe public class GLX
	{
		...
		[DllImport(Library)] public static extern bool glXIsDirect(IntPtr dpy, IntPtr context);
		[DllImport(Library)] public static extern bool glXQueryExtension(IntPtr dpy, ref int errorBase, ref int eventBase);
		[DllImport(Library)] public static extern IntPtr glXQueryExtensionsString(IntPtr dpy, int screen);
		[DllImport(Library)] public static extern IntPtr glXCreateContext(IntPtr dpy, XVisualInfo* vis, IntPtr shareList, bool direct);
		...
		[DllImport(Library)] public static extern void glXDestroyContext(IntPtr dpy, IntPtr context);
		[DllImport(Library)] public static extern IntPtr glXGetCurrentContext();
		[DllImport(Library)] public static extern bool glXMakeCurrent(IntPtr display, IntPtr drawable, IntPtr context);
		[DllImport(Library)] public static extern void glXSwapBuffers(IntPtr display, IntPtr drawable);
		[DllImport(Library)] public static extern IntPtr glXGetProcAddress([MarshalAs(UnmanagedType.LPTStr)] string procName);
		[DllImport(Library)] public static extern int glXGetConfig(IntPtr dpy, ref XVisualInfo vis, GLXAttribute attrib, out int value);
		[DllImport(Library)] public static extern IntPtr glXChooseVisual(IntPtr dpy, int screen, int* attriblist);
		...
		[DllImport(Library)] public static extern IntPtr* glXChooseFBConfig(IntPtr dpy, int screen, int[] attriblist, out int fbount); // Returns an array of GLXFBConfig structures.
		[DllImport(Library)] public static extern XVisualInfo* glXGetVisualFromFBConfig(IntPtr dpy, IntPtr fbconfig);
