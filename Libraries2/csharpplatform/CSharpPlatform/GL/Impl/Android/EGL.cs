...
namespace CSharpPlatform.GL.Impl.Android
{
	unsafe public class EGL
	{
		...
		[DllImport(Library)] static public extern EGLint eglGetError();
		[DllImport(Library)] static public extern EGLDisplay eglGetDisplay(EGLNativeDisplayType display_id);
		[DllImport(Library)] static public extern EGLBoolean eglInitialize(EGLDisplay dpy, EGLint* major, EGLint* minor);
		[DllImport(Library)] static public extern EGLBoolean eglTerminate(EGLDisplay dpy);
		[DllImport(Library)] static public extern byte* eglQueryString(EGLDisplay dpy, EGLint name);
		[DllImport(Library)] static public extern EGLBoolean eglGetConfigs(EGLDisplay dpy, EGLConfig* configs, EGLint config_size, EGLint* num_config);
		[DllImport(Library)] static public extern EGLBoolean eglChooseConfig(EGLDisplay dpy, EGLint* attrib_list, EGLConfig* configs, EGLint config_size, EGLint* num_config);
		[DllImport(Library)] static public extern EGLBoolean eglGetConfigAttrib(EGLDisplay dpy, EGLConfig config, EGLint attribute, EGLint* value);
		[DllImport(Library)] static public extern EGLSurface eglCreateWindowSurface(EGLDisplay dpy, EGLConfig config, EGLNativeWindowType win, EGLint* attrib_list);
		[DllImport(Library)] static public extern EGLSurface eglCreatePbufferSurface(EGLDisplay dpy, EGLConfig config, EGLint* attrib_list);
		[DllImport(Library)] static public extern EGLSurface eglCreatePixmapSurface(EGLDisplay dpy, EGLConfig config, EGLNativePixmapType pixmap, EGLint* attrib_list);
		[DllImport(Library)] static public extern EGLBoolean eglDestroySurface(EGLDisplay dpy, EGLSurface surface);
		[DllImport(Library)] static public extern EGLBoolean eglQuerySurface(EGLDisplay dpy, EGLSurface surface, EGLint attribute, EGLint* value);
		[DllImport(Library)] static public extern EGLBoolean eglBindAPI(EGLenum api);
		[DllImport(Library)] static public extern EGLenum eglQueryAPI();
		[DllImport(Library)] static public extern EGLBoolean eglWaitClient();
		[DllImport(Library)] static public extern EGLBoolean eglReleaseThread();
		[DllImport(Library)] static public extern EGLSurface eglCreatePbufferFromClientBuffer(EGLDisplay dpy, EGLenum buftype, EGLClientBuffer buffer, EGLConfig config, EGLint* attrib_list);
		[DllImport(Library)] static public extern EGLBoolean eglSurfaceAttrib(EGLDisplay dpy, EGLSurface surface, EGLint attribute, EGLint value);
		[DllImport(Library)] static public extern EGLBoolean eglBindTexImage(EGLDisplay dpy, EGLSurface surface, EGLint buffer);
		[DllImport(Library)] static public extern EGLBoolean eglReleaseTexImage(EGLDisplay dpy, EGLSurface surface, EGLint buffer);
		[DllImport(Library)] static public extern EGLBoolean eglSwapInterval(EGLDisplay dpy, EGLint interval);
		[DllImport(Library)] static public extern EGLContext eglCreateContext(EGLDisplay dpy, EGLConfig config, EGLContext share_context, EGLint* attrib_list);
		[DllImport(Library)] static public extern EGLBoolean eglDestroyContext(EGLDisplay dpy, EGLContext ctx);
		[DllImport(Library)] static public extern EGLBoolean eglMakeCurrent(EGLDisplay dpy, EGLSurface draw, EGLSurface read, EGLContext ctx);
		[DllImport(Library)] static public extern EGLContext eglGetCurrentContext();
		[DllImport(Library)] static public extern EGLSurface eglGetCurrentSurface(EGLint readdraw);
		[DllImport(Library)] static public extern EGLDisplay eglGetCurrentDisplay();
		[DllImport(Library)] static public extern EGLBoolean eglQueryContext(EGLDisplay dpy, EGLContext ctx, EGLint attribute, EGLint* value);
		[DllImport(Library)] static public extern EGLBoolean eglWaitGL();
		[DllImport(Library)] static public extern EGLBoolean eglWaitNative(EGLint engine);
		[DllImport(Library)] static public extern EGLBoolean eglSwapBuffers(EGLDisplay dpy, EGLSurface surface);
		[DllImport(Library)] static public extern EGLBoolean eglCopyBuffers(EGLDisplay dpy, EGLSurface surface, EGLNativePixmapType target);
		[DllImport(Library)] static public extern IntPtr eglGetProcAddress(string procname);
