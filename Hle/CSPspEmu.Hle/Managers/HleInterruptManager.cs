...
namespace CSPspEmu.Hle.Managers
{
    ...
    public sealed class HleInterruptHandler
    {
        ...
        public void Trigger()
        {
            if (HleInterruptManager.Enabled)
            {
                ...
                {
                    HleInterruptManager.Queue(HleCallback.Create("InterruptTrigger", Handler.Address, Handler.Index,
                        Handler.Argument));
                }
            }
    ...
    public sealed class HleInterruptManager : IInterruptManager
    {
        ...
        public bool Enabled
        {
            get { return CpuProcessor.InterruptEnabled; }
            set { CpuProcessor.InterruptEnabled = value; }
        }
        //public bool Enabled;
        ...
        public bool Flag
        {
            get { return CpuProcessor.InterruptFlag; }
            set { CpuProcessor.InterruptFlag = value; }
        }
        //public bool Flag;
