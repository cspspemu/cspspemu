...
namespace CSPspEmu
{
	...
	{
		static private void StartWithoutArguments(PspEmulator PspEmulator)
		{
#if !RELEASE
			...
			//PspEmulator.StartAndLoad(@"E:\Isos\psp\Castlevania Dracula X Chronicles.iso", EnableMpeg: false);
